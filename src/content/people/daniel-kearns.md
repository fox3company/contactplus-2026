...
role_summary:
  en: Performer of Descent and FIELD.
  ro: Performer în Descent și FIELD.
  ru: Исполнитель Descent и FIELD.
short_profile:
...
extended_profile:
  ...
  ru: В Descent его сценическое присутствие проходит через память, детское удивление и внутренние ландшафты. В FIELD он участвует в коллективном перформативном языке DUNE Dance Company, связанном со слушанием, резонансом и трансформацией.
festival_events:
  - event_id: descent
    relation: performer
  - event_id: field
