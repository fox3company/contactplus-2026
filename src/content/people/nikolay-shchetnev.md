...
role_summary:
  en: Samovarteateret artist in the film / presentation Outside/Inside (Norway).
  ro: Artist Samovarteateret în filmul / prezentarea Outside/Inside (Norway).
  ru: Артист Samovarteateret в фильме / презентации Outside/Inside (Norway).
short_profile:
...
extended_profile:
  ...
  ru: Оригинальная сценическая работа соединяет импровизационную музыку, танец, театр, сценографическое повествование и видео. Nikolay входит в исходные credits работы и участвует в публичном обсуждении на Contact+.
festival_events:
