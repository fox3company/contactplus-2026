---
entity_type: company
participation_status: production_company
public_listing: true
name: Samovarteateret
country_display: Norway
role_summary:
  en: Company behind Outside/Inside (Norway).
  ro: Compania din spatele Exterior/Interior (Norvegia).
  ru: Компания, стоящая за «Снаружи/Внутри (Норвегия)».
short_profile:
  en: Samovarteateret is an independent professional theatre company based in Kirkenes, Norway, near the borders with Russia and Finland. Its work uses border landscapes, multilingual performance and physical theatre as material for cross-border artistic collaboration.
  ro: Samovarteateret este o companie profesionistă independentă de teatru din Kirkenes, Norvegia, aproape de granițele cu Rusia și Finlanda. Lucrul ei folosește peisajele de frontieră, performance-ul multilingv și teatrul fizic ca material pentru colaborare artistică transfrontalieră.
  ru: Samovarteateret — независимая профессиональная театральная компания из Киркенеса, Норвегия, рядом с границами России и Финляндии. Её работа использует пограничные ландшафты, многоязычный перформанс и физический театр как материал для трансграничного художественного сотрудничества.
extended_profile:
  en: >-
