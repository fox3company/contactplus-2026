...
role_summary:
  ...
  ru: Молдавская танцевальная компания, представляющая Light from the Shadow.
short_profile:
  ...
  ru: Молдавская dance company, представляющая мультимедийную работу с contemporary dance, музыкой, текстом и проекциями.
extended_profile:
  ...
  ru: Light from the Shadow вдохновлён жизнью, любовью и творческой памятью, обращаясь к текстам и пути поэта и писателя XIX века. В контексте Contact+ Alexandra Soshnicova и Sergey Golovnea также связаны с Voices как хореографы-руководители и танцовщики.
festival_events:
