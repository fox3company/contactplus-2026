...
focus_label:
  ...
  ru: Фокус практики / JAM
focus:
  en: Body organization · center of gravity · subtle contact · listening · transition into JAM
  ro: Organizare corporală · centru de greutate · contact subtil · ascultare · tranziție spre JAM
  ru: Организация тела · центр тяжести · тонкий контакт · слушание · переход в JAM
body:
  en: >-
...
media:
  hero: bodywork-as-dialogue-hero-placeholder
  gallery: []
related:
  events: []
  people: [sergey-semichev]
---

# Bodywork as Dialogue
