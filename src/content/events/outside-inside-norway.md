...
credits:
  full_source:
    ...
    ro: "Lista completă a echipei de producție poate rămâne în contextul intern al sursei."
    ru: "Полный список производственной команды может оставаться во внутреннем исходном контексте."
  items:
    - label:
        en: Production
        ro: Producție
...
**Meta**  
Перформанс · фильм / презентация + обсуждение

**Название**  
Снаружи/Внутри (Норвегия)
...
**Медиа-заметки**  
Рекомендуемые материалы: трейлер, кадр из работы, портрет / фото Nikolay Shchetnev, визуал Samovarteateret.
